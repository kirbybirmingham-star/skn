...
// Note: dotenv.config() is already called in server/index.js before importing any modules
const supabaseUrl = process.env.VITE_SUPABASE_URL;
const supabaseKey = process.env.SUPABASE_SERVICE_ROLE_KEY;

let supabase = null;
if (!supabaseUrl || !supabaseKey) {
  console.warn('Supabase service key not configured; verifySupabaseJwt middleware will reject requests.');
} else {
