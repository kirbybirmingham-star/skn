...
INSERT INTO public.product_variants (product_id, seller_id, sku, price_in_cents, compare_at, inventory_quantity, is_active, attributes, images)
VALUES
  -- Laptop variants
  ('b8c9d0e1-f2a3-4567-8901-cdef01234567', 'b2c3d4e5-f6a7-8901-2345-67890abcdef0', 'LP-13-GRY', 120000, 125000, 10, true, '{"size": "13-inch", "color": "Gray"}', '[]'),
  ('b8c9d0e1-f2a3-4567-8901-cdef01234567', 'b2c3d4e5-f6a7-8901-2345-67890abcdef0', 'LP-15-SLV', 150000, null, 5, true, '{"size": "15-inch", "color": "Silver"}', '[]'),
  -- T-Shirt variants
  ('c9d0e1f2-a3b4-5678-9012-def012345678', 'a1b2c3d4-e5f6-7890-1234-567890abcdef', 'TS-M-BLK', 2500, 3000, 50, true, '{"size": "M", "color": "Black"}', '[]'),
  ('c9d0e1f2-a3b4-5678-9012-def012345678', 'a1b2c3d4-e5f6-7890-1234-567890abcdef', 'TS-L-WHT', 2500, null, 30, true, '{"size": "L", "color": "White"}', '[]'),
  -- Coffee Mug variants
  ('d0e1f2a3-b4c5-6789-0123-ef0123456789', 'a1b2c3d4-e5f6-7890-1234-567890abcdef', 'CM-STD-BLU', 1500, null, 100, true, '{"size": "Standard", "color": "Blue"}', '[]'),
  -- Smartphone variants
  ('e1f2a3b4-c5d6-7890-1234-f01234567890', 'b2c3d4e5-f6a7-8901-2345-67890abcdef0', 'SP-64-BLK', 80000, 85000, 20, true, '{"size": "64GB", "color": "Black"}', '[]'),
  ('e1f2a3b4-c5d6-7890-1234-f01234567890', 'b2c3d4e5-f6a7-8901-2345-67890abcdef0', 'SP-128-GLD', 90000, null, 15, true, '{"size": "128GB", "color": "Gold"}', '[]'),
  -- Jeans variants
  ('f2a3b4c5-d6e7-8901-2345-012345678901', 'a1b2c3d4-e5f6-7890-1234-567890abcdef', 'JN-32-BLU', 6000, null, 40, true, '{"size": "32", "color": "Blue"}', '[]'),
  ('f2a3b4c5-d6e7-8901-2345-012345678901', 'a1b2c3d4-e5f6-7890-1234-567890abcdef', 'JN-34-BLK', 6000, 6500, 25, true, '{"size": "34", "color": "Black"}', '[]')
